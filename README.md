# 💫 Hello there:
Целеустремленный и ориентированный на детали разработчик Flutter с опытом работы в области компьютерных наук и инженерии, более чем трехлетним опытом исследований и годом реального опыта разработки готовых к работе мобильных приложений. Умею воплощать сложные идеи в интуитивно понятные, высокопроизводительные пользовательские интерфейсы и сотрудничать с межфункциональными командами для создания масштабируемых решений. Готов поделиться техническим опытом и творческим подходом с дальновидными командами разработчиков. Посетите мой веб-сайт по адресу http://www.aduojo.tech

Недавний проект: https://github.com/ExcelWhite/KUWAIA/tree/main
